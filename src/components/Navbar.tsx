    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? "py-3 bg-white/95 dark:bg-[#0f0f11]/95 border-b border-card-border/50 shadow-sm"
            : "py-5 bg-white/90 dark:bg-[#0f0f11]/90 md:bg-transparent md:py-6"
        }`}
      >
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-18 left-4 right-4 z-40 max-w-sm mx-auto bg-card border border-card-border/60 shadow-2xl p-6 pb-6 rounded-[24px] md:hidden flex flex-col"
            >
              {/* Grab Handle */}
